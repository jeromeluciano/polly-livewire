...
@switch($name)
    ...
    @case("loading")
        <svg viewBox="0 0 38 38" xmlns="http://www.w3.org/2000/svg" {{ $attributes->merge()->class("w-6 h-6") }}>
            <defs>
